...
from ..activity import ENRTL, NRTL, UNIQUAC, UNIFAC
    ...
    def init_activities(
        ...
        **kwargs
        ...
        NRTL | UNIQUAC | UNIFAC | ENRTL: object
            Activity model object for the calculation of activity coefficient
        '''
        try:
            # SECTION: keywords
            # NOTE: kwargs
            ...
            if check_reference and activity_model != 'ENRTL':
                reference = self._references.get(activity_model, None)
            ...
            elif activity_model == 'ENRTL':
                return ActivityCore_.enrtl
            else:
    ...
    def select_activities(
        ...
        **kwargs
        ...
        try:
            ...
            # SECTION: init fugacity core
            activity_components = components if activity_model == 'ENRTL' else component_ids
