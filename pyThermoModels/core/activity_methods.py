    ...
    **kwargs
    ...
    tau_correlation : Literal['M1', 'M2', 'M3', 'M4', 'M5'], optional
        Correlation method for calculating tau_ij, by default 'M1'.
            - 'M1': Calculate tau_ij using dg_ij.
            - 'M2': Calculate tau_ij from constants a, b, c, d based on the selected correlation.
            - 'M3': Calculate tau_ij from constants a, b based on the selected correlation.
            - 'M4': Calculate tau_ij from constants a, b, c based on the selected correlation.
            - 'M5': Calculate tau_ij from constants a, b, c based on the selected correlation.
