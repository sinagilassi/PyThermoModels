...
class LocalCompositionModel:
    def __init__(
        ...
        ** kwargs
        ...
        '''
        Initialize the LocalCompositionModel with components and their indices.
        ...
        component_idx: Dict[str, int]
            Dictionary mapping component names to their indices in the mixture.
        **kwargs: dict
